...
#    cbar1.ax.set_xlabel('Atlas  MMI /\n ShakeMap 3.5 MMI')
    ...
    if (args.imt == 'pga') & (args.stat == 'mean'):
        ...
        cbar1.ax.set_ylabel('log PGA',fontsize=14)
...
if __name__ == '__main__':
    ...
    pargs = parser.parse_args(['/Users/dengler/shakemap_profiles/default/data/ci38457511/Current/grid_og.xml',
                                '-i', 'pga','-s','mean', '-l', 'W2018 Model Conditional Ground Motion', 
